...
.box1 h3 { float:left; font-size:12px;text-align:left;  color: #FFFFFF;width:98px; line-height:33px;}
.box1 h4 { float:left; font-size:12px; text-align:left; color: #FFFFFF; width:33px; line-height:33px; margin-top: 6px; }
...
<g:form action="confirm" useToken="true">
    <div class="box">
        ...
        <div class="login1" style="margin-top:20px;">
            <h1>解约客户账户：<font color="red">*</font></h1>
