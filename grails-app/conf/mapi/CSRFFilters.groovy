...
class CSRFFilters {
    ...
    static sqlKey=[" and ", " exec "," execute ", " count ", " chr ", " mid ", " master ", " or ", " truncate ", " char ", " declare ", " join ",'<','>','/*','*/',"'",'\\u',"insert ", "select ", "delete ", "update ","create ","drop ","union ","having ",'%20','where ','script','<img','%3cimg','%20or%20','%20and%20','--','eval']
    def filters = {
